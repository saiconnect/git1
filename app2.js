...
mongoose.connect('mongodb://localhost/user', /*function(err, db)*/{
...
app.post('/userSuccess', function(req, res, next) {
    console.log("INFO: Use logged in successful" + req.body);
    console.log(req.body.username );
    UserDetails.find({'username': req.body.username }, function(err, docs) {
    console.log(docs );
    if(err){
	console.log(err);
